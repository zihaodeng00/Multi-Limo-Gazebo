...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, limo_msgs, action, LimoAction_SendGoal)() {
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_limo_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, limo_msgs, action, LimoAction_GetResult)() {
